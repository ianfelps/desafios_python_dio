...
# lista de modelos de IA pré-definidos
modelos = [
...
def recomendar_modelo(caracteristicas):
    ...
    # converte as capacidades inseridas pelo usuário para minúsculas
...
# obtém as características desejadas pelo usuário
caracteristicas_entrada = obter_caracteristicas()

# recomenda o modelo com base nas características do usuário
melhor_modelo = recomendar_modelo(caracteristicas_entrada)

# gera a explicação para a recomendação
